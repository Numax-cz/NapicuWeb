function morenula(L) {
  ...
  const text4 = ["Žer!", "Nažer se jako!", "Žer! Nebo umřeš!", "To chce hodně jídla!"]
  ...
  const text7 = ["MMA?", "Beton", "Cihle", "Moravák", "Židle", "Stůl", "DDOS","Windows 11","Linux Vista", "napicu.eu", "vanoce.pinktube.eu"]
