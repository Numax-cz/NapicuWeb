...
function Plosiny(Vyska, Pozice1, Pozice2, SirkaLine, ObjektMoznostSkoku, Barva, LevelName, debugging){
  // PoziceHraceY + Sirka_Desky*3 ( Pozice "0" tesně nad deskou)
  // PoziceHraceY + Sirka_Desky*4 (Přímo v bloku když sirka_desky = 10...... 10*4 = 40 - v bloku)
  // PoziceBloku2Y = PoziceHraceY + Sirka_Desky*3; (Pozice "0" - střed objektu sirka_desky)

  PoziceBloku2Y = PoziceHraceY + Sirka_Desky*3 - Vyska; 
  Blok2HW = Pozice1;
