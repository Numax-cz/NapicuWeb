...
const country_list_element = document.querySelector(".mesta-list");
const chang_country_btn = document.querySelector(".zmenit-zemi");
const close_list_btn = document.querySelector(".zav");
...
function createCountryList(){
    const num_countries = meso_list.length;

    let i = 0, ul_list_id;

    meso_list.forEach( (country, index) => {
